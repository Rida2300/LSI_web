            ...
            <div className="px-4">
              <div className="flex flex-col lg:flex-row justify-between items-start gap-4 lg:gap-8">
                ...
                <div className="w-full lg:w-80 h-[171px] rounded-xl overflow-hidden flex-shrink-0">
                  <img
                    src="https://i.postimg.cc/0jn713TT/Depth-6-Frame-1-7.png"
          ...
          <div className="mb-8">
            ...
            <div className="px-4">
              <div className="flex flex-col lg:flex-row justify-between items-start gap-4 lg:gap-8">
                ...
                <div className="w-full lg:w-80 h-[171px] rounded-xl overflow-hidden flex-shrink-0">
                  <img
                    src="https://i.postimg.cc/gJn02769/Depth-6-Frame-1-8.png"
          ...
          <div className="mb-8">
            ...
            <div className="px-4">
              <div className="flex flex-col lg:flex-row justify-between items-start gap-4 lg:gap-8">
                ...
                <div className="w-full lg:w-80 h-[171px] rounded-xl overflow-hidden flex-shrink-0">
                  <img
                    src="https://i.postimg.cc/yxRYFSPv/Depth-6-Frame-1-9.png"
          ...
          <div className="mb-8">
            ...
            <div className="px-4">
              <div className="flex flex-col lg:flex-row justify-between items-start gap-4 lg:gap-8">
                ...
                <div className="w-full lg:w-80 h-[171px] rounded-xl overflow-hidden flex-shrink-0">
                  <img
                    src="https://i.postimg.cc/1tky53Q6/Depth-6-Frame-1-10.png"
          ...
          <div className="mb-8">
            ...
            <div className="px-4">
              <div className="flex flex-col lg:flex-row justify-between items-start gap-4 lg:gap-8">
                ...
                <div className="w-full lg:w-80 h-[171px] rounded-xl overflow-hidden flex-shrink-0">
                  <img
                    src="https://i.postimg.cc/pr35vH01/Depth-6-Frame-1-13.png"
          ...
          <div className="mb-12">
            ...
            <div className="px-4">
              <div className="flex flex-col lg:flex-row justify-between items-start gap-4 lg:gap-8">
                ...
                <div className="w-full lg:w-80 h-[171px] rounded-xl overflow-hidden flex-shrink-0">
                  <img
                    src="https://i.postimg.cc/wvfsWJDz/Depth-6-Frame-1-14.png"
