...
const features = [
  {
    ...
    description: "Receive immediate notifications for leaks, unusual usage, and potential issues.",
  ...
  },
  {
    ...
    description: "Get detailed information about your water quality, including hardness, pH levels, and more.",
...
const useCases = [
  {
    ...
    description: "Track water usage in your apartment and split bills fairly among residents.",
    imageSrc: "https://i.postimg.cc/zXdCfyB4/Depth-7-Frame-0-2.png",
  },
  {
    title: "Bungalow Bliss",
    description: "Monitor your bungalow's water consumption and identify areas for conservation.",
    imageSrc: "https://i.postimg.cc/wjZDhnDV/Depth-7-Frame-0-3.png",
  },
  {
    title: "Gated Community",
    description: "Manage water usage across multiple homes in your gated community with ease.",
    imageSrc: "https://i.postimg.cc/k4d8H81R/Depth-7-Frame-0-4.png",
  },
];

const footerLinks = ["About Us", "Contact", "Support", "Terms of Service", "Privacy Policy"];

const Residential = () => (
  <Layout>
    <div className="min-h-screen bg-white max-w-6xl mx-auto px-6 lg:px-20 py-20">
      {/* Hero Section */}
      <div className="flex flex-col lg:flex-row items-center gap-8 mb-20">
        <div className="flex-1 flex justify-center items-center bg-[#67b6cd] border border-[#23276a] rounded-xl p-8">
          <img
        ...
        <div className="flex-1 space-y-8">
          <div className="space-y-2">
            <h1 className="font-inter text-5xl lg:text-4xl font-black text-[#141414] leading-[50px] tracking-tight">
              Smart Water for Smart Homes
            </h1>
            <p className="font-inter text-base text-[#141414]">
              Take control of your water usage with Blue Meter. Monitor, manage, and conserve water effortlessly.
            </p>
          </div>
      ...
      <div className="mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-3">
          {plans.map((plan) => (
            <div key={plan.name} className="bg-white border border-[#e0e0e0] rounded-xl p-6 space-y-4">
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  <h3 className="font-inter text-base font-bold text-[#141414]">{plan.name}</h3>
                  {plan.isRecommended && (
                    <div className="bg-white rounded-xl px-3 py-1">
                      <span className="font-inter text-xs font-medium text-[#141414]">Recommended</span>
                    </div>
                  )}
                </div>
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="font-inter text-base font-bold text-[#141414]">/month</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                {plan.features.map((feature) => (
                  <div key={feature} className="flex items-center gap-3">
                    ...
                    <span className="font-inter text-sm text-[#141414]">{feature}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="mb-8">
        ...
        <div className="bg-white border border-[#e0e0e0] rounded-xl p-6 min-w-[288px]">
          <div className="space-y-2 mb-4">
            <h3 className="font-inter text-base font-medium text-[#141414]">Water Usage & Savings</h3>
            <div className="font-inter text-3xl font-bold text-[#141414]">₹11250</div>
            <div className="flex items-center gap-1">
              <span className="font-inter text-base text-[#757575]">Last 12 Months</span>
              <span className="font-inter text-base font-medium text-[#088708]">+20%</span>
            </div>
          </div>
            ...
            {["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"].map(
              (month) => (
                <div key={month} className="flex flex-col items-center gap-6">
                  ...
                  ></div>
                  <span className="font-inter text-xs font-bold text-[#757575]">{month}</span>
                </div>
              )
            )}
          </div>
      ...
      <div className="mb-8 w-full h-[497px] bg-[#63a6a7] rounded-xl overflow-hidden">
        <img
      ...
      {/* Features */}
      <div className="mb-12">
        <h2 className="font-inter text-2xl font-bold text-[#141414] leading-7 mb-10">Features</h2>
        <div className="grid md:grid-cols-3 gap-3">
          {features.map((feature) => (
            <div key={feature.title} className="bg-white border border-[#e0e0e0] rounded-lg p-4 space-y-3">
              <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d={feature.svgPath} fill="#141414" />
              </svg>
              <div className="space-y-1">
                <h3 className="font-inter text-base font-bold text-[#141414]">{feature.title}</h3>
                <p className="font-inter text-sm text-[#757575] leading-[21px]">{feature.description}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-3">
          {useCases.map((useCase) => (
            <div key={useCase.title} className="space-y-3">
              ...
              />
              <div className="space-y-1">
                <h3 className="font-inter text-base font-medium text-[#141414]">{useCase.title}</h3>
                <p className="font-inter text-sm text-[#757575] leading-[21px]">{useCase.description}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="mb-8">
        <div className="bg-white border border-[#e0e0e0] rounded-xl p-5 space-y-1">
          <h3 className="font-inter text-base font-bold text-[#141414]">Did You Know?</h3>
          <p className="font-inter text-base text-[#757575]">
            A leaky faucet can waste up to 3,000 gallons of water per year. Blue Meter helps you identify and fix leaks quickly.
          </p>
        </div>
      </div>
      ...
      <div className="text-center space-y-8 py-20">
        <div className="space-y-2">
          ...
          <p className="font-inter text-base text-[#141414]">
            Join thousands of homeowners who are saving water and money with Blue Meter.
          </p>
        </div>
      ...
      {/* Family Illustration */}
      <div className="w-full h-[619px] bg-[#F0F8FF] rounded-xl overflow-hidden mb-8">
        <img
